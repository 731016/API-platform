...
-- ----------------------------
INSERT INTO `interface_info` VALUES (1705234447153963010, '幽默段子', 'https://api.xiaofei.site/api/interface/poisonousChickenSoup', 1698354419367571457, 'GET', NULL, '[{\"id\":\"1695051685885\",\"fieldName\":\"code\",\"type\":\"int\",\"desc\":\"响应码\"},{\"id\":\"1695052930602\",\"fieldName\":\"data.text\",\"type\":\"string\",\"desc\":\"幽默段子\"},{\"id\":\"1695052955781\",\"fieldName\":\"message\",\"type\":\"string\",\"desc\":\"响应描述\"}]', 1, 'https://api.xiaofei.site/api/interface/poisonousChickenSoup', NULL, NULL, 'JSON', '只为博君一笑', 1, 90, 'https://img.xiaofei.site/interface_icon/huixieyulu.png', '2023-09-22 22:55:48', '2024-06-06 21:53:28', 0);
INSERT INTO `interface_info` VALUES (1705237104270712833, '获取输入的名称', 'https://api.xiaofei.site/api/interface/name', 1698354419367571457, 'GET', '[{\"id\":\"1695031845159\",\"fieldName\":\"name\",\"type\":\"string\",\"desc\":\"输入的名称\",\"required\":\"是\"}]', '[{\"id\":\"1695105888173\",\"fieldName\":\"data.name\",\"type\":\"object\",\"desc\":\"输入的参数\"},{\"id\":\"1695382937817\",\"fieldName\":\"code\",\"type\":\"int\",\"desc\":\"响应码\"},{\"id\":\"1695382949291\",\"fieldName\":\"message\",\"type\":\"string\",\"desc\":\"响应信息描述\"}]', 1, 'https://api.xiaofei.site/api/interface/name', NULL, NULL, 'JSON', '获取输入的名称', 2, 2, 'https://img.xiaofei.site/interface_icon/name.png', '2023-09-22 23:06:22', '2024-05-02 17:44:42', 1);
INSERT INTO `interface_info` VALUES (1705237990061580289, '随机壁纸', 'https://api.xiaofei.site/api/interface/randomWallpaper', 1698354419367571457, 'GET', '[{\"id\":\"1695032007961\",\"fieldName\":\"method\",\"type\":\"string\",\"desc\":\"壁纸输出端：[ pc | mobile | zsy ]，默认为pc端\",\"required\":\"否\"},{\"id\":\"1695032018924\",\"fieldName\":\"lx\",\"type\":\"string\",\"desc\":\"壁纸类型：[ fengjing | dongman | meizi | suiji ]，默认为风景\",\"required\":\"否\"}]', '[{\"id\":\"1695051751595\",\"fieldName\":\"code\",\"type\":\"string\",\"desc\":\"响应码\"},{\"id\":\"1695051832571\",\"fieldName\":\"data.imgurl\",\"type\":\"string\",\"desc\":\"返回的壁纸地址\"},{\"id\":\"1695051861456\",\"fieldName\":\"message\",\"type\":\"string\",\"desc\":\"响应消息\"}]', 1, 'https://api.xiaofei.site/api/interface/randomWallpaper', NULL, NULL, 'JSON', '获取随机壁纸', 1, 109, 'https://img.xiaofei.site/interface_icon/bizhi.png', '2023-09-22 23:09:53', '2024-06-06 21:52:55', 0);
INSERT INTO `interface_info` VALUES (1705238841173942274, '星座运势', 'https://api.xiaofei.site/api/interface/horoscope', 1698354419367571457, 'GET', '[{\"id\":\"1695382662346\",\"fieldName\":\"type\",\"type\":\"string\",\"desc\":\"十二星座：aries(白羊), taurus(金牛), gemini(双子), cancer(巨蟹), leo(狮子), virgo(处女), libra(天秤), scorpio(天蝎), sagittarius(射手), capricorn(摩羯), aquarius(水瓶), pisces(双鱼)\",\"required\":\"是\"},{\"id\":\"1695382692472\",\"fieldName\":\"time\",\"type\":\"string\",\"desc\":\"时间：today(今天), nextday(明天), week(本周), month(本月), year(本年)\",\"required\":\"是\"}]', '[{\"id\":\"1695382701088\",\"fieldName\":\"code\",\"type\":\"int\",\"desc\":\"响应码\"},{\"id\":\"1695382720309\",\"fieldName\":\"todo.yi\",\"type\":\"string\",\"desc\":\"宜做\"},{\"id\":\"1695382741895\",\"fieldName\":\"todo.ji\",\"type\":\"string\",\"desc\":\"忌做\"},{\"id\":\"1695382783855\",\"fieldName\":\"fortunetext.all\",\"type\":\"string\",\"desc\":\"整体运势\"},{\"id\":\"1695382810906\",\"fieldName\":\"fortunetext.love\",\"type\":\"string\",\"desc\":\"爱情运势\"},{\"id\":\"1695382836727\",\"fieldName\":\"fortunetext.work\",\"type\":\"string\",\"desc\":\"工作运势\"},{\"id\":\"1695382864966\",\"fieldName\":\"fortunetext.money\",\"type\":\"string\",\"desc\":\"财运运势\"},{\"id\":\"1695382888169\",\"fieldName\":\"fortunetext.health\",\"type\":\"string\",\"desc\":\"健康运势\"},{\"id\":\"1695382912920\",\"fieldName\":\"fortune.all\",\"type\":\"int\",\"desc\":\"整体运势评分\"},{\"id\":\"1695382931057\",\"fieldName\":\"fortune.love\",\"type\":\"int\",\"desc\":\"爱情运势评分\"},{\"id\":\"1695382952540\",\"fieldName\":\"fortune.work\",\"type\":\"int\",\"desc\":\"工作运势评分\"},{\"id\":\"1695382975321\",\"fieldName\":\"fortune.money\",\"type\":\"int\",\"desc\":\"财运运势评分\"},{\"id\":\"1695382999222\",\"fieldName\":\"fortune.health\",\"type\":\"int\",\"desc\":\"健康运势评分\"},{\"id\":\"1695383027074\",\"fieldName\":\"shortcomment\",\"type\":\"string\",\"desc\":\"简评\"},{\"id\":\"1695383057554\",\"fieldName\":\"luckycolor\",\"type\":\"string\",\"desc\":\"幸运颜色\"},{\"id\":\"1695383079261\",\"fieldName\":\"index.all\",\"type\":\"string\",\"desc\":\"整体指数\"},{\"id\":\"1695383102324\",\"fieldName\":\"index.love\",\"type\":\"string\",\"desc\":\"爱情指数\"},{\"id\":\"1695383125487\",\"fieldName\":\"index.work\",\"type\":\"string\",\"desc\":\"工作指数\"},{\"id\":\"1695383149310\",\"fieldName\":\"index.money\",\"type\":\"string\",\"desc\":\"财运指数\"},{\"id\":\"1695383173441\",\"fieldName\":\"index.health\",\"type\":\"string\",\"desc\":\"健康指数\"},{\"id\":\"1695383203920\",\"fieldName\":\"luckynumber\",\"type\":\"string\",\"desc\":\"幸运数字\"},{\"id\":\"1695383227323\",\"fieldName\":\"time\",\"type\":\"string\",\"desc\":\"日期\"},{\"id\":\"1695383247152\",\"fieldName\":\"title\",\"type\":\"string\",\"desc\":\"星座名称\"},{\"id\":\"1695383269015\",\"fieldName\":\"type\",\"type\":\"string\",\"desc\":\"运势类型\"},{\"id\":\"1695383292088\",\"fieldName\":\"luckyconstellation\",\"type\":\"string\",\"desc\":\"幸运星座\"},{\"id\":\"1695383314942\",\"fieldName\":\"message\",\"type\":\"string\",\"desc\":\"响应描述\"}]', 1, 'https://api.xiaofei.site/api/interface/horoscope', '', NULL, 'JSON', '看看你今日的运势吧', 1, 52, 'https://img.xiaofei.site/interface_icon/xingzuo.png', '2023-09-22 23:13:16', '2024-05-21 23:32:13', 0);
INSERT INTO `interface_info` VALUES (1705239469589733378, '土味情话', 'https://api.xiaofei.site/api/interface/loveTalk', 1698354419367571457, 'GET', NULL, '[{\"id\":\"1695382126371\",\"fieldName\":\"code\",\"type\":\"int\",\"desc\":\"响应码\"},{\"id\":\"1695382173816\",\"fieldName\":\"data.value\",\"type\":\"string\",\"desc\":\"随机土味情话\"},{\"id\":\"1695382205869\",\"fieldName\":\"message\",\"type\":\"string\",\"desc\":\"返回信息描述\"}]', 1, 'https://api.xiaofei.site/api/interface/loveTalk', NULL, NULL, 'JSON', '爱你在心口难开', 1, 142, 'https://img.xiaofei.site/interface_icon/love.png', '2023-09-22 23:15:46', '2024-06-06 21:49:02', 0);
INSERT INTO `interface_info` VALUES (1705239928861827073, 'IP归属地', 'https://api.xiaofei.site/api/interface/ipInfo', 1698354419367571457, 'GET', '[{\"id\":\"1695388304868\",\"fieldName\":\"ip\",\"type\":\"string\",\"desc\":\"输入IP地址\",\"required\":\"是\"}]', '[{\"id\":\"1695382701088\",\"fieldName\":\"code\",\"type\":\"int\",\"desc\":\"响应码\"},{\"id\":\"1695382720309\",\"fieldName\":\"data.ip\",\"type\":\"string\",\"desc\":\"IP地址\"},{\"id\":\"1695382741895\",\"fieldName\":\"data.info.country\",\"type\":\"string\",\"desc\":\"国家\"},{\"id\":\"1695382783855\",\"fieldName\":\"data.info.prov\",\"type\":\"string\",\"desc\":\"省份\"},{\"id\":\"1695382810906\",\"fieldName\":\"data.info.city\",\"type\":\"string\",\"desc\":\"城市\"},{\"id\":\"1695382836727\",\"fieldName\":\"data.info.lsp\",\"type\":\"string\",\"desc\":\"运营商\"},{\"id\":\"1695382864966\",\"fieldName\":\"message\",\"type\":\"string\",\"desc\":\"响应描述\"}]', 1, 'https://api.xiaofei.site/api/interface/ipInfo', NULL, NULL, 'JSON', '获取IP归属地信息', 1, 42, 'https://img.xiaofei.site/interface_icon/ip_info.png', '2023-09-22 23:17:35', '2024-05-19 12:04:49', 0);
INSERT INTO `interface_info` VALUES (1705240565347459073, '天气查询', 'https://api.xiaofei.site/api/interface/weather', 1698354419367571457, 'GET', '[{\"id\":\"1695392098947\",\"fieldName\":\"city\",\"type\":\"string\",\"desc\":\"输入城市（地级市或直辖市）\",\"required\":\"否\"},{\"id\":\"1695392118560\",\"fieldName\":\"ip\",\"type\":\"string\",\"desc\":\"输入IP\",\"required\":\"否\"},{\"id\":\"1695392127763\",\"fieldName\":\"type\",\"type\":\"string\",\"desc\":\"输入week查询一周天气，默认一天\",\"required\":\"否\"}]', '[{\"id\":\"1695382701088\",\"fieldName\":\"code\",\"type\":\"int\",\"desc\":\"响应码\"},{\"id\":\"1695382720309\",\"fieldName\":\"city\",\"type\":\"string\",\"desc\":\"城市\"},{\"id\":\"1695382741895\",\"fieldName\":\"date\",\"type\":\"string\",\"desc\":\"日期\"},{\"id\":\"1695382783855\",\"fieldName\":\"week\",\"type\":\"string\",\"desc\":\"星期几\"},{\"id\":\"1695382810906\",\"fieldName\":\"type\",\"type\":\"string\",\"desc\":\"天气类型\"},{\"id\":\"1695382836727\",\"fieldName\":\"low\",\"type\":\"string\",\"desc\":\"最低温度\"},{\"id\":\"1695382864966\",\"fieldName\":\"high\",\"type\":\"string\",\"desc\":\"最高温度\"},{\"id\":\"1695382892007\",\"fieldName\":\"fengxiang\",\"type\":\"string\",\"desc\":\"风向\"},{\"id\":\"1695382918740\",\"fieldName\":\"fengli\",\"type\":\"string\",\"desc\":\"风力\"},{\"id\":\"1695382951685\",\"fieldName\":\"night.type\",\"type\":\"string\",\"desc\":\"夜间天气类型\"},{\"id\":\"1695382977506\",\"fieldName\":\"night.fengxiang\",\"type\":\"string\",\"desc\":\"夜间风向\"},{\"id\":\"1695383004749\",\"fieldName\":\"night.fengli\",\"type\":\"string\",\"desc\":\"夜间风力\"},{\"id\":\"1695383032988\",\"fieldName\":\"air.aqi\",\"type\":\"int\",\"desc\":\"空气质量指数\"},{\"id\":\"1695383052210\",\"fieldName\":\"air.aqi_level\",\"type\":\"int\",\"desc\":\"空气质量指数级别\"},{\"id\":\"1695383072789\",\"fieldName\":\"air.aqi_name\",\"type\":\"string\",\"desc\":\"空气质量指数名称\"},{\"id\":\"1695383098609\",\"fieldName\":\"air.co\",\"type\":\"string\",\"desc\":\"一氧化碳浓度\"},{\"id\":\"1695383124245\",\"fieldName\":\"air.no2\",\"type\":\"string\",\"desc\":\"二氧化氮浓度\"},{\"id\":\"1695383149267\",\"fieldName\":\"air.o3\",\"type\":\"string\",\"desc\":\"臭氧浓度\"},{\"id\":\"1695383173716\",\"fieldName\":\"air.pm10\",\"type\":\"string\",\"desc\":\"PM10浓度\"},{\"id\":\"1695383198557\",\"fieldName\":\"air.pm25\",\"type\":\"string\",\"desc\":\"PM2.5浓度\"},{\"id\":\"1695383222398\",\"fieldName\":\"air.so2\",\"type\":\"string\",\"desc\":\"二氧化硫浓度\"},{\"id\":\"1695383249835\",\"fieldName\":\"tip\",\"type\":\"string\",\"desc\":\"提示信息\"},{\"id\":\"1695383275472\",\"fieldName\":\"message\",\"type\":\"string\",\"desc\":\"响应描述\"}]', 1, 'https://api.xiaofei.site/api/interface/weather', NULL, NULL, 'JSON', '获取每日的天气信息', 1, 127, 'https://img.xiaofei.site/interface_icon/weather.png', '2023-09-22 23:20:07', '2024-06-06 21:52:20', 0);
INSERT INTO `interface_info` VALUES (1785417203737575425, '网易云Hot', 'https://api.xiaofei.site/api/interface/wyHotMusic', 1780561892755771394, 'GET', NULL, NULL, 2, 'https://api.xiaofei.site/api/interface/wyHotMusic', NULL, NULL, 'JSON', '获取网易云热榜歌曲', 1, 547, 'https://img.xiaofei.site/interface_icon/wymusic.png', '2024-05-01 05:13:27', '2024-06-06 14:27:25', 0);
INSERT INTO `interface_info` VALUES (1785417696081756161, '动漫头像', 'https://api.xiaofei.site/api/interface/cartoonAvatar', 1780561892755771394, 'GET', NULL, NULL, 1, 'https://api.xiaofei.site/api/interface/cartoonAvatar', NULL, NULL, 'JSON', '获取动漫头像', 1, 302, 'https://img.xiaofei.site/interface_icon/dongman.png', '2024-05-01 05:15:24', '2024-06-06 21:48:03', 0);
INSERT INTO `interface_info` VALUES (1785418020532142082, '手机号归属地', 'https://api.xiaofei.site/api/interface/phoneInfo', 1780561892755771394, 'GET', '[{\"id\":\"1714512494552\",\"fieldName\":\"phone\",\"type\":\"string\",\"desc\":\"手机号码\",\"required\":\"是\"}]', NULL, 1, 'https://api.xiaofei.site/api/interface/phoneInfo', NULL, NULL, 'JSON', '获取手机号归属地信息', 1, 45, 'https://img.xiaofei.site/interface_icon/号码归属地.png', '2024-05-01 05:16:42', '2024-06-06 21:48:50', 0);
INSERT INTO `interface_info` VALUES (1785418263822745602, '职场人日历', 'https://api.xiaofei.site/api/interface/calendar', 1780561892755771394, 'GET', NULL, NULL, 1, 'https://api.xiaofei.site/api/interface/calendar', NULL, NULL, 'JSON', '有趣的职场人专属日历', 1, 45, 'https://img.xiaofei.site/interface_icon/日历.png', '2024-05-01 05:17:40', '2024-05-21 23:32:28', 0);
INSERT INTO `interface_info` VALUES (1791421137002332161, '测试接口', 'https://api.xiaofei.site/api/interface/test', 1780561892755771394, 'GET', NULL, NULL, 1, NULL, NULL, NULL, 'JSON', '测试接口', 1, 0, NULL, '2024-05-17 18:50:56', '2024-05-18 16:10:47', 1);
